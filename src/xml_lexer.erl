...
yystate(9, [10|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line+1, Tlen+1, 0, Tlen);
...
-file("src/xml_lexer.xrl", 8).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/1}).
-file("src/xml_lexer.xrl", 9).
yyaction_1(TokenLine) ->
     { token, { equals, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/xml_lexer.xrl", 10).
yyaction_2(TokenLine) ->
     { token, { open, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/xml_lexer.xrl", 11).
yyaction_3(TokenLine) ->
     { token, { close, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/xml_lexer.xrl", 12).
yyaction_4(TokenLine) ->
     { token, { slash, TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("src/xml_lexer.xrl", 13).
yyaction_5(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, list_to_binary (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("src/xml_lexer.xrl", 14).
yyaction_6(TokenChars, TokenLine) ->
